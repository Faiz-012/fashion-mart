                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
							<a href="cartremove/{{ $item->cart_id }}" class="btn btn-black btn-sm">X</a>
						</td>							
                        </tr>
						@endforeach
                ...
                <div class="col-md-6 pl-5">
                  <div class="row justify-content-end">
                    <div class="col-md-7">
                      ...
                      <div class="row">
						  <div class="col-md-12">
							  <a href="/cancel_order/{{ $data[0]->Checkout_id }}" class="btn btn-black btn-lg py-3 btn-block" style="margin-top: 40px">Cancel Order</a>
